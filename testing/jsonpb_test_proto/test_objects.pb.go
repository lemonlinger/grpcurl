...
func (*KnownTypes) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{0} }
...
func init() { proto.RegisterFile("testing/jsonpb_test_proto/test_objects.proto", fileDescriptor0) }
